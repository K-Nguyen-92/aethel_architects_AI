...
const ArchitectLanding = () => {
  return (
    ...
    >
      ...
      {/* Hero Content */}
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-4 pb-20">
        ...
        <button className="bg-[#b35a39] hover:bg-[#9a4d31] text-white px-10 py-4 text-sm font-semibold tracking-wider uppercase transition-colors duration-300 shadow-lg cursor-pointer">
